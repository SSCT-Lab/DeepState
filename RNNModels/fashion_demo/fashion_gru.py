...
class FashionGRUClassifier:
    ...
    def reload_dense(self, model_path):
        ...
        dense = Dense(10, activation='softmax', name="dense")(drop)
...
if __name__ == "__main__":
    ...
    #
    # model = lstm_classifier.load_hidden_state_model(os.path.join(save_path, "fashion_gru.h5"))
    # print(model.predict(np.array([x_test[0]]))[0])
    # # lstm_classifier.profile_train_data(profile_path)
    #
    # m1 = load_model(os.path.join(save_path, "fashion_gru.h5"))
